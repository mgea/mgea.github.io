...
function preload() {
   imgs[0] = loadImage("jalberich1.png");
   imgs[1] = loadImage("jalberich2.png");
   imgs[2] = loadImage("jalberich3.png");
   imgs[3] = loadImage("jalberich4.png");
   imgs[4] = loadImage("jalberich4b.png");
