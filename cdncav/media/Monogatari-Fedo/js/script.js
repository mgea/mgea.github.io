...
let script = {
	...
	"Pasillo": [
        ...
        "scene maquinas",
        "show f surprised with bounceInRight",
    ...
    "end"
     ...
     "Avid": [
        ...
        "fran Si quieres te pongo un ordenador.",
          "show fran normal right with tada",
    ...
    "Patio": [
        "stop music",
        "scene claustro",
        "show f sad with bounceInRight",   
        "f ¿Dónde estoy? Creo que me he perdido… Y esas estatuas dan mal rollo…",
        "show super normal at right with fadeInRightBig",
        "show f surprised at left ",
     ...
     "Perverso": [
        "show f sad  at left with shake",
        "show super normal  at right with shake",
        "play sound puñetazo.mp3",
        "show f hurt at left with jackInTheBox",   
        "f ¿Qué ha sido eso?",
        "super Esa respuesta es tal perversidad que hasta las estatuas han cobrado vida para pegarte. Será mejor que no vuelvas por aquí",
         "show f sad at left with rollIn",
         "jump gameover"
	],
    
    
    "Escuchar": [
        "show estrella normal at right with shake",
        "show f happy  at left with shake",
    ...
    "Escaleras": [
        ...
        "show f surprised with bounceInLeft", 
     ...
     "decano": [
         ...
         "show b normal at right with flip",
    ...
    "show b normal at right with bounceOutDown",  
    // "hide b with fadeOut ",
   ...
   // "hide b at left with bounceOut",
    ...
    "end"
     ...
     "Jardin": [
    "scene exterior",
    "show f happy with  slideInDown",
    "Fedo mira a ambos", 
    "f Wow, se ve toda Graná, qué maravilla…",
       "show f happy with  shake",  
    ...
    "end"
     ...
     "Cafeteria": [
        ...
        "play music grito",
        "scene cafeteria",    
        "show julio normal at right with bounceInLeft",
        "show f surprised at left with pulse",
         {
			"Choice": {
